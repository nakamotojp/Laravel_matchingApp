...
<div class="search" style="width:377px; padding:7px; background-color:#D8BfD8">
    ...
    <div class="popular">
        <button type="button" id="searchpart" class="btn btn-light" style="color:dimgrey;"><i class="fas fa-heart">&ensp;</i>
            In descending order of likes</button>
    </div>

    <div class="eventtye d-flex" style="margin-top:7px; margin-bottom:7px;">
        <button id="searchpart2" type="button" class="btn btn-light" style="color:dimgrey; margin-right:5px;">date</button>
        <button id="searchpart3" type="button" class="btn btn-light" style="color:dimgrey; margin-right:5px;">sexual</button>
        <button id="searchpart4" type="button" class="btn btn-light" style="color:dimgrey; margin-right:5px;">party</button>
        <button id="searchpart5" type="button" class="btn btn-light" style="color:dimgrey; margin-right:5px;">outdoor</button>
        <button id="searchpart6" type="button" class="btn btn-light" style="color:dimgrey; margin-right:2px;">online</button>
    </div>
