...
<div class="row">
    <div class="col-md-10 col-md-offset-2 mx-auto">
        ...
        <form method="POST" action="{{ route('users.updateProfile') }}" onSubmit="return checkSubmit()">
          @csrf
            <div class="form-group">
                <label for="age">age</label>
            <input id="title" name="age" class="form-control"
                    value="{{ $profile->age }}" type="text">
                @if ($errors->has('age'))
            ...
            <input id="title" name="income" class="form-control"
                    value="{{ $profile->income }}" type="text">
            ...
            <div class="form-group">
                ...
                rows="13">{{ $profile->introduce }}</textarea>
